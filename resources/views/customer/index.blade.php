    ...
    <div class="col-lg-12">
        <div class="row mt-2 mb-2">
            <div class="col-lg-6 mb-2">
                <a href="{{ route('customer.add') }}" class="btn btn-sm shadow-sm myBtn border rounded">
            ...
            <div class="col-lg-6">
                <form class="d-flex" method="GET" action="{{ route('customer.search') }}">
                    <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" id="search" name="q"
                        value="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-light btn-sm rounded shadow-sm border delete" href="#"
                                                    ...
                                                    customer-url="{{ route('customer.destroy', ['customer' => $customer->id]) }}">
                                                    <svg width="25" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
