...
<div class="bg-light border-right shadow-sm mt-3" id="sidebar-wrapper">
    <div class="d-flex flex-column bg-light" style="width: 4.5rem;">
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="nav-item">
                <a href="/dashboard"
                    class="nav-link py-3 border-bottom myBtn @if (stripos($_SERVER['REQUEST_URI'], 'dashboard' ) !==false) active @endif"
            ...
            <li>
                <a href="/payment"
                    class="nav-link py-3 border-bottom myBtn @if (stripos($_SERVER['REQUEST_URI'], 'payment' ) !==false) active @endif"
            ...
            <li>
                <div class="dropend">
                    <a class="nav-link py-3 border-bottom myBtn @if (stripos($_SERVER['REQUEST_URI'], 'room') !==false) active @elseif(stripos($_SERVER['REQUEST_URI'], 'type') !==false) active @endif"
            ...
            <li>
                <div class="dropend">
                    <a class="nav-link py-3 border-bottom myBtn @if (stripos($_SERVER['REQUEST_URI'], 'customer') !==false) active @elseif(stripos($_SERVER['REQUEST_URI'], 'user') !==false) active @endif"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <svg width="25" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
