                        ...
                        <div class="col-sm-12 mt-2">
                            <form id="paymentForm" method="POST" action="{{ route('transaction.reservation.payDownPayment', ['customer' => $customer->id, 'room' => $room->id]) }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('downPayment') is-invalid @enderror" id="downPayment" name="downPayment" placeholder="Input payment here" value="{{ old('downPayment') }}">
                                        @error('downPayment')
                                ...
                                <button type="submit" class="btn btn-primary float-end" id="payButton">Pay DownPayment</button>
                            </form>
                        </div>
                    </div>
                </div>
