        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <ul class="progress-indicator m-4">
                    <li
                        class="{{ Route::currentRouteName() == 'reservation.createIdentity' ? 'completed' : '' }} {{ Route::currentRouteName() == 'reservation.countPerson' ? 'completed' : '' }} {{ Route::currentRouteName() == 'reservation.chooseRoom' ? 'completed' : '' }} {{ Route::currentRouteName() == 'reservation.chooseDay' ? 'completed' : '' }} {{ Route::currentRouteName() == 'reservation.payDownPayment' ? 'completed' : '' }}">
